...
class JsonTagMapCodecTest extends \PHPUnit_Framework_TestCase {
  ...
  public function testSerializeSimpleAnnotatedMessage() {
    $simple = new tests\Annotated\Simple();
    $simple->foo = 'FOO';
    $simple->bar = 1000;
    $json = Protobuf::encode($simple);
    $this->assertEquals($json, '{"1":"FOO","2":1000}');
  }

  public function testSerializeRepeatedFieldsAnnotatedMessage() {
